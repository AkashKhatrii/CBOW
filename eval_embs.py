...
def get_eval_stats(emb_file):   
    ...
    analogy = wv.evaluate_word_analogies("/scratch/general/vast/u1469481/cs6957/assignment1/models/test_files/questions-words_headered.txt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--emb_file", default="/scratch/general/vast/u1469481/cs6957/assignment1/models/embeddings.txt", type=str)
